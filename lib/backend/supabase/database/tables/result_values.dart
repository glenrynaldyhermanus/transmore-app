...
class ResultValuesTable extends SupabaseTable<ResultValuesRow> {
  @override
  String get tableName => 'result_values';

  @override
  ResultValuesRow createRow(Map<String, dynamic> data) => ResultValuesRow(data);
}

class ResultValuesRow extends SupabaseDataRow {
  ResultValuesRow(super.data);

  @override
  SupabaseTable get table => ResultValuesTable();
