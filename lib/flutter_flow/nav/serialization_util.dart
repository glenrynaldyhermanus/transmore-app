  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ClientUsersRow:
            return ClientUsersRow(data);
          case SpatialRefSysRow:
            return SpatialRefSysRow(data);
          case ItemFormFieldsViewRow:
            return ItemFormFieldsViewRow(data);
          case PlacesStoreViewRow:
            return PlacesStoreViewRow(data);
          case ItemsViewRow:
          ...
          case WorkerUsersViewRow:
            return WorkerUsersViewRow(data);
          case FormsRow:
            return FormsRow(data);
          case ResultValuesItemsRow:
            return ResultValuesItemsRow(data);
          case OptionsGroupedViewRow:
            return OptionsGroupedViewRow(data);
          case FormPagesRow:
            return FormPagesRow(data);
          ...
          case OptionsViewRow:
            return OptionsViewRow(data);
          case ResultsRow:
            return ResultsRow(data);
          case OptionsRow:
            return OptionsRow(data);
          case TasksViewRow:
            return TasksViewRow(data);
          case AdminUsersViewRow:
